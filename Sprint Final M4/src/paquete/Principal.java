...
public class Principal {
    ...
    /**
     * Almacena un nuevo usuario en el contenedor. Opcion 1 del Menu Principal.
     *
    ...
    private static void almacenarUsuario(Contenedor contenedor, Scanner scanner) {
        ...
        while (!datosCorrectos) {
            try {
                ...
                System.out.println(" ");
                System.out.println(" Usuario almacenado exitosamente.");
                System.out.println(" ");
                datosCorrectos = true;  // Salir del bucle si todos los datos son correctos
                ...
                switch (tipoUsuario) {
                    case 1 -> {
                        ...
                        cliente.setEdad(cliente.calcularEdad());
                        scanner.nextLine();
                        contenedor.almacenarCliente(cliente);
                        // Una vez almacenado el cliente, se da registro a una visita en terreno
                        visitasATerreno(contenedor, scanner);
                    }
                    case 2 -> {
    ...
    /**
     * Método que permite almacenar una capacitación en el contenedor. Opcion 2
     * del Menu Principal.
     *
     * @param contenedor de Datos
     * @param scanner de toma de datos
     */
    ...
    /**
     * Método que permite almacenar un accidente en el contenedor. Opción 5 del
     * Menu Principal.
     *
     * @param contenedor de Datos
     * @param scanner de toma de datos
    ...
    /**
     * Método que permite almacenar una revisión en el contenedor. Opción 7 del
     * Menu Principal.
     *
     * @param contenedor de Datos
     * @param scanner de toma de datos
    ...
    /**
     * Método que permite eliminar un usuario del contenedor. Opcion 8 del Menu
     * Principal.
     *
     * @param contenedor de Datos
     * @param scanner de toma de datos
